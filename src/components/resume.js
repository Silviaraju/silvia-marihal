      ...
      <div>
        <Grid>
          <Cell col={4}>
            ...
            <h4 style={{color: 'grey'}}>Software Engineer / Software Developer</h4>
            <hr style={{borderTop: '3px solid #833fb2', width: '50%'}}/>
            <p>Aspiring Software/Web/Full-stack Developer/Engineer with over 5 years of experience specializing in HTML, CSS, JavaScript/TypeScript, Java, and ReactJS. 
              Deep understanding of the Software Development Life Cycle (SDLC) and strong expertise in object-oriented programming. 
              Committed to delivering scalable web applications, I continuously explore emerging technologies to drive remarkable outcomes in fast-paced development environments..</p>
            <hr style={{borderTop: '3px solid #833fb2', width: '50%'}}/>
            <h5>ADDRESS</h5>
            <p>11353 Avenida De Los Lobos, San Diego, California 92127</p>
            <h5>PHONE</h5>
            <p>(316) 213-8196</p>
            <h5>EMAIL</h5>
          ...
          <Cell className="resume-right-col" col={8}>
            ...
            <Education
              ...
              schoolDescription="During my Master's program, I focused on the intricate art of designing and developing software systems by leveraging scientific analysis and mathematical models. 
              My expertise lies in utilizing these tools to predict and measure outcomes, ensuring precise and impactful design consequences."
             />

               <Education
                 startYear="AUGUST 2013"
                 endYear="JULY 2017"
                 schoolName="SAMBHRAM INSTITUE OF TECHNOLOGY, Bachelor's in Information Science and Engineering"
                 schoolDescription="In the realm of academia, I immersed myself in the captivating study of the theoretical and practical foundations of information processing. Delving into the intricate realm of computations, 
                 I explored the profound art of solving practical problems and crafting innovative solutions that push the boundaries of what is possible."
                  />
